...
-----------------------------------------------------------------
-- Web-site: http://lua-users.org/wiki/LappFramework
-- Author:   Copyright (c) 2009 by Steve Donovan
-- Date:     Downloaded 2011-05-17
-- License:  Same as Lua 5.x, i.e. MIT license
--   http://www.lua.org/license.html#5
--   http://www.opensource.org/licenses/mit-license.html
--
-- Modifications
-- ~~~~~~~~~~~~~
-- - Parameter "-h" isn't hard-coded to print usage information.
-----------------------------------------------------------------
--~ -- args.lua
